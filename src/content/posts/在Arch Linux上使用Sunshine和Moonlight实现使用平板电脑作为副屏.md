...
![通过KMS的强制设置显示模式创建的虚拟显示器](https://resource.rainafter.cn/img/20250708232555345.jpg)
...
2. 再将虚拟显示器的EDID数据复制到一个想要保存的目录中（该目录需要记住，接下来的步骤中会使用到该目录）
...
![自定义EDID文件](https://resource.rainafter.cn/img/20250617140623522.png)
> 自定义EDID文件
...
![成功修改分辨率后的虚拟显示器](https://resource.rainafter.cn/img/20250617135314179.png)
> 成功修改分辨率后的虚拟显示器
